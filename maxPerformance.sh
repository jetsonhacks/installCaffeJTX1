#!/bin/sh
# Taken from the NVIDIA Jetson TX1 forum:
# https://devtalk.nvidia.com/default/topic/901337/jetson-tx1/cuda-7-0-jetson-tx1-performance-and-benchmarks/post/4747186/post/4747186/#4747186
